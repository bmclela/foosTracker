      ...
      <Card id='background' style={{ margin: '40px' }}>
        <Card.Body>
          ...
          <Card.Text style={{ fontSize: 14 }}>
            ...
            and I as we played foosball games. Because the original application
            is still used regularly, this is a separate instance to showcase my
            work. Feel free to add your own games and mess around with the data
          ...
          <Card.Text style={{ fontSize: 14 }}>
            ...
            foosball games. To start, add players by clicking Add Player. You
            can see a list of existing players above the input box. Once you
            have enough players, click Add Game and select the players that won
            and lost the game. After clicking submit, you will see the
